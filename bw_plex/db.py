...
class Processed(Base):
    ...
    correct_theme_start = Column(
        "correct_theme_start", Integer, nullable=True
    )  # This for manual override.
    correct_theme_end = Column(
        "correct_theme_end", Integer, nullable=True
    )  # This for manual override.
    ...
    correct_ffmpeg = Column(
        "correct_ffmpeg", Integer, nullable=True
    )  # This for manual override.
